...
buttonWeb = [
    ...
    types.InlineKeyboardButton(text="Сайты/Веб-Приложения", callback_data="web_web_app"),
    types.InlineKeyboardButton(text="Десктопные приложения", callback_data="web_desktop_app"),
